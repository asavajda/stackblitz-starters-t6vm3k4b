    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white p-8 rounded-xl border border-gray-200 max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Racconto caricato</h2>
          <p className="text-gray-500 text-sm mb-6">Il racconto è stato salvato correttamente.</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 w-full max-w-2xl mx-auto">
        ...
        <h1 className="text-2xl font-semibold text-gray-800 mb-2">Carica un racconto</h1>
        <p className="text-sm font-medium text-gray-700 mb-2">Contest Letterario "I Racconti del Gatto Nero"</p>
<p className="text-sm text-gray-500 mb-6">26th ToHorror Fantastic Film Fest</p>

        <div className="space-y-5">

          <div className="bg-gray-50 rounded-lg p-4 space-y-4">
            <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Dati autore</p>
          ...
          {tipoInvio === 'testo' ? (
            ...
            <div>
              ...
              <p className="text-xs text-amber-600 mt-1">
                Il racconto non deve superare 18.000 battute (spazi inclusi).
              </p>
            </div>
          )}
          ...
          >
            {caricamento ? 'Caricamento in corso...' : 'Carica racconto'}
          </button>
        </div>
      </div>
    </div>
