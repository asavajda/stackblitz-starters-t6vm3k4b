  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 overflow-x-hidden">
      <div className="relative w-full max-w-md">
        <div
          className="pointer-events-none absolute z-0 -top-10 -bottom-10 -left-10 -right-10 sm:-top-14 sm:-bottom-14 sm:-left-24 sm:-right-24 rounded-full border-[3px] border-black"
        />
